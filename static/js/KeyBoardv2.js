...
function getKeyId (inputLetter, language) {
  for (let key in keyMap) {
    if (keyMap[key][language][0].includes(inputLetter)) {
      return key  
    }
...
<div id="keyboard">
		...
		<li><a href="#" className="key c81"><span>q</span><span>{keyMap.c81[currentKeyboard][0][0]}</span></a></li>
	    	<li><a href="#" className="key c87"><span>w</span><span>{keyMap.c87[currentKeyboard][0][0]}</span></a></li>
	    	<li><a href="#" className="key c69"><span>e</span><span>{keyMap.c69[currentKeyboard][0][0]}</span></a></li>
	    	<li><a href="#" className="key c82"><span>r</span><span>{keyMap.c82[currentKeyboard][0][0]}</span></a></li>
	    	<li><a href="#" className="key c84"><span>t</span><span>{keyMap.c84[currentKeyboard][0][0]}</span></a></li>
	    	<li><a href="#" className="key c89"><span>y</span><span>{keyMap.c89[currentKeyboard][0][0]}</span></a></li>
	    	<li><a href="#" className="key c85"><span>u</span><span>{keyMap.c81[currentKeyboard][0][0]}</span></a></li>
	    	<li><a href="#" className="key c73"><span>i</span><span>{keyMap.c85[currentKeyboard][0][0]}</span></a></li>
	    	<li><a href="#" className="key c79"><span>o</span><span>{keyMap.c79[currentKeyboard][0][0]}</span></a></li>
	    	<li><a href="#" className="key c80"><span>p</span><span>{keyMap.c80[currentKeyboard][0][0]}</span></a></li>
	    	<li><a href="#" className="key c219 alt"><b>{'{'}</b><span>{keyMap.c80[currentKeyboard][0][0]}</span></a></li>
	    	<li><a href="#" className="key c221 alt"><b>{'}'}</b><span>{keyMap.c80[currentKeyboard][0][0]}</span></a></li>
        ...
        <ul className="cf" id="asdfg">
	    	...
	    	<li><a href="#" className="key c65"><span>a</span><span>{keyMap.c65[currentKeyboard][0][0]}</span></a></li>
	    	<li><a href="#" className="key c83" ><span>s</span><span>{keyMap.c83[currentKeyboard][0][0]}</span></a></li>
	    	<li><a href="#" className="key c68" ><span>d</span><span>{keyMap.c68[currentKeyboard][0][0]}</span></a></li>
	    	<li><a href="#" className="key c70"><span>f</span><span>{keyMap.c70[currentKeyboard][0][0]}</span></a></li>
	    	<li><a href="#" className="key c71"><span>g</span><span>{keyMap.c71[currentKeyboard][0][0]}</span></a></li>
	    	<li><a href="#" className="key c72"><span>h</span><span>{keyMap.c72[currentKeyboard][0][0]}</span></a></li>
	    	<li><a href="#" className="key c74"><span>j</span><span>{keyMap.c74[currentKeyboard][0][0]}</span></a></li>
	    	<li><a href="#" className="key c75"><span>k</span><span>{keyMap.c75[currentKeyboard][0][0]}</span></a></li>
	    	<li><a href="#" className="key c76"><span>l</span><span>{keyMap.c76[currentKeyboard][0][0]}</span></a></li>
	    	<li><a href="#" className="key c186 alt"><span>;</span><span>{keyMap.c186[currentKeyboard][0][0]}</span></a></li>
	    	<li><a href="#" className="key c222 alt"><span>'</span><span>{keyMap.c222[currentKeyboard][0][0]}</span></a></li>
        ...
        <ul className="cf" id="zxcvb">
	    	...
	    	<li><a href="#" className="key c90"><span>z</span><span>{keyMap.c90[currentKeyboard][0][0]}</span></a></li>
	    	<li><a href="#" className="key c88"><span>x</span><span>{keyMap.c88[currentKeyboard][0][0]}</span></a></li>
	    	<li><a href="#" className="key c67"><span>c</span><span>{keyMap.c67[currentKeyboard][0][0]}</span></a></li>
	    	<li><a href="#" className="key c86"><span>v</span><span>{keyMap.c86[currentKeyboard][0][0]}</span></a></li>
	    	<li><a href="#" className="key c66"><span>b</span><span>{keyMap.c66[currentKeyboard][0][0]}</span></a></li>
	    	<li><a href="#" className="key c78"><span>n</span><span>{keyMap.c78[currentKeyboard][0][0]}</span></a></li>
	    	<li><a href="#" className="key c77"><span>m</span><span>{keyMap.c77[currentKeyboard][0][0]}</span></a></li>
	    	<li><a href="#" className="key c188 alt"><span>{keyMap.c188[currentKeyboard][0][0]}</span></a></li>
	    	<li><a href="#" className="key c190 alt"><span>{keyMap.c190[currentKeyboard][0][0]}</span></a></li>
	    	<li><a href="#" className="key c191 alt"><span>{keyMap.c191[currentKeyboard][0][0]}</span></a></li>
